...
class AgentWorkflow:
    ...
    def full_pipeline(self, question: str, retriever: EnsembleRetriever):
        try:
            ...
            documents = retriever.invoke(question)     #retrieve relavant documents from the database
    ...
    def _research_step(self, state: AgentState) -> Dict:
        ...
        result = self.researcher.generate(state["question"], state["documents"], feedback)
